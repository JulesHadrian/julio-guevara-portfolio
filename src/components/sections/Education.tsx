...
export default function Education() {
  ...
  return (
    <section id="education" className="px-6 py-20 border-t transition-colors duration-200" style={{ borderColor: "var(--border)" }}>
        ...
        >
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-sm mb-2" style={{ color: "var(--accent)" }}>{t("institution")}</p>
